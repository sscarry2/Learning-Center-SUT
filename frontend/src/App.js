...
class App extends Component {
  ...
  getUserById = () => {
    UsersById().then(users => {
      console.log('Image.getById : ',users.userImage);
  ...
  onMakeBooking = ({
    ...
    const bookingData = { startDate, endDate, subject, purpose, roomId };
    ...
    try {
      makeBooking(
        { startDate, endDate, subject, purpose, roomId, recurringData },
        existingBookings
      ).then(updatedRoom => {
  ...
  onSetBuildingParam = value => {
    this.setState({ buildingParam: value });
  };
  ...
  render() {
    ...
    if (!!roomData) {
      // Send all room data and the selected building, return filtered buildings and store in filteredData
      filteredData = onFilterByBuilding(buildingParam, roomData);
                      ...
                      <div className='wrapper'>
                        ...
                        <div className='wrapper__content'>
                          ...
                          <div className='sidebar'>
                            ...
                            <div className='sidebar__box'>
                              <FilterElement
                                onSetBuildingParam={this.onSetBuildingParam}
