            ...
            <tr>
              <td className={`table__cell`}>
                <span
                  ...
                  className={`table__cell--booked table__cell--${firstBookingData.subject // Class name will show the subject that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
                    }
                  `}
                >
                  &nbsp;
              ...
              <td className={`table__cell`}>
                <span
                  ...
                  className={`table__cell--booked table__cell--${secondBookingData.subject // Class name will show the subject that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
                    }
                  `}
                >
                  &nbsp;
      ...
      tableRow.push(
        <td className={`table__cell`}>
          <span
            ...
            className={`table__cell--booked table__cell--${bookingData.subject // Class name will show the subject that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
              .replace(/ /g, '-')
              .toLowerCase()}
