      ...
      {!!props.selectedBooking && (
        <div className='modal__boday'>
          <p className='modal__paragraph'>
            ...
            {', Building '}
            {findRoomInfo(props.selectedBooking.roomId, props.roomData).building}
          </p>
          <p className='modal__paragraph'>
            {`${momentTimezone
              .tz(props.selectedBooking['bookingStart'], 'Asia/Bangkok')
              .format('h.mma')} to ${momentTimezone
              .tz(props.selectedBooking['bookingEnd'], 'Asia/Bangkok')
              .format('h.mma')}`}
            <p className='modal__paragraph'>
              {`${momentTimezone
                .tz(props.selectedBooking['bookingStart'], 'Asia/Bangkok')
